...
export const Icon = {
  ...
  gear: (p: P) => (
    <Svg {...p}><path d="M4 7h9M17 7h3M4 12h3M11 12h9M4 17h11M19 17h1" /><circle cx="15" cy="7" r="2" /><circle cx="9" cy="12" r="2" /><circle cx="17" cy="17" r="2" /></Svg>
  ),
  tag: (p: P) => (
    <Svg {...p}><path d="M3.5 12.2V5a1.5 1.5 0 0 1 1.5-1.5h7.2a1.5 1.5 0 0 1 1 .44l7.3 7.3a1.5 1.5 0 0 1 0 2.12l-7.2 7.2a1.5 1.5 0 0 1-2.12 0l-7.3-7.3a1.5 1.5 0 0 1-.38-1.06Z" /><circle cx="8.5" cy="8.5" r="1.5" /></Svg>
  ),
  eye: (p: P) => (
